...
public class HorizontalTwoButtonDialog extends Dialog {
    // 버튼 리스너
    ...
    public HorizontalTwoButtonDialog(@NonNull Context context, View.OnClickListener firstBtnListener, View.OnClickListener secondBtnListener, String textViewText, String firstBtnText, String secondBtnText) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_horizontal_two_button);

        // TextView Text 설정
        TextView textView = findViewById(R.id.dialog_horizontal_two_button_textView);
        textView.setText(textViewText);

        // 두 버튼에 리스너 연결
        Button firstButton = findViewById(R.id.dialog_horizontal_two_button_first_button);
        firstButton.setOnClickListener(firstBtnListener);
        firstButton.setText(firstBtnText);

        Button secondButton = findViewById(R.id.dialog_horizontal_two_button_second_button);
